...
<link rel="stylesheet" href="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/css/giftbook.css";?>" />
<!--位置 star-->
        <div class="theme">
            <div class="site">
                <img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index/gif_08.jpg";?>">您所在的位置：<a href="../Default.aspx">首页</a> &gt;  礼品册购买</div>
        </div>
    <!--位置 end-->
    <!--礼品册左边 star-->
    <div class="giftboos_left">
        <div class="gL03_up">
            <img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index/gb03_Top.jpg";?>"></div>
        <div class="gL03_middle">
            
                    <dl>
                        <dt>
                            礼品册主题分类</dt>
                        
                                <?php foreach($festival_list as $key => $item){?>
                                      <?php $id = $item['id']?>
                                <dd>
                                    <a href="<?php echo IUrl::creatUrl("/simple/festival/id/$id");?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo isset($item['name'])?$item['name']:"";?>
                                    </a>
                                </dd>
                                <?php }?>
                    </dl>
            ...
            <dl>
                <dt>礼品册价位分类</dt>
                        <?php foreach($price_list as $key => $item){?>
                             <?php $price = $item['price']?>
                        <dd>
                            <a href="<?php echo IUrl::creatUrl("/simple/festival/price/$price");?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo isset($price)?$price:"";?>
                            </a>
                        </dd>
                        <?php }?>
            </dl>
        ...
        <div class="gL03_down">
            <img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index/gb03_Bottom.jpg";?>"></div>
    </div>
    <!--礼品册左边 end-->
    <!--礼品册右边边 star-->
    <div class="giftbooks_right">
        <div class="giftbooks_banner">
            
            <a href=""><img src="http://images.dfld.cn/banner/channel_01.jpg" alt="东方礼道礼品册" title="东方礼道礼品册"></a>


        </div>
        <div class="gb_Rcontent_up">
            <img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index/rbox_top.jpg";?>"></div>
        <div class="gb_Rcontent_middle">
            <h1>
                最新礼品推荐</h1>
            <ul class="gb03_product">
                        <?php foreach($volumes_list as $key => $item){?>
                            <?php $id = $item['id'];
                                $thumbs =  explode(',',$item['thumb']);
                                $thumbs = preg_replace( "/(\.\w*$)/" ,"_175_175$1" ,$thumbs  );
                            ?>
                           <li>
                            <div class="pic">
                                <a href="<?php echo IUrl::creatUrl("/simple/volumes/id/$id");?>">
                                    <img src="<?php echo isset($thumbs[0])?$thumbs[0]:"";?>"></a></div>
                            <h3 class="pro_info">
                                <?php echo isset($item['title'])?$item['title']:"";?></h3>
                        </li>
                        <?php }?>
        ...
        <div class="gb_Rcontent_down">
            
            <img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index/rbox_bottom.jpg";?>"></div>
    </div>
    <!--礼品册右边边 end-->
    </div>
    <!-- main end -->
