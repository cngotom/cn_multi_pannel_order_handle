...
<div class="ucenter container">
    ...
    <div class="box m_10">
        <table class="list_table" width="100%" cellpadding="0" cellspacing="0">
            ...
            <?php $order = new IQuery("order");$order->where = "user_id = $user[user_id] and if_del = 0";$order->page = "$page";$order->order = "id desc";$items = $order->find(); foreach($items as $key => $item){?>
            <tr>
                <td><a href="<?php echo IUrl::creatUrl("/ucenter/order_detail/id/$item[id]");?>" class="orange"><?php echo isset($item['order_no'])?$item['order_no']:"";?></a></td><td><?php echo isset($item['create_time'])?$item['create_time']:"";?></td><td><?php echo isset($item['accept_name'])?$item['accept_name']:"";?></td><td><?php echo isset($this->payments[$item['pay_type']]['name'])?$this->payments[$item['pay_type']]['name']:"";?></td><td>￥<?php echo sprintf("%01.2f",($item['order_amount']));?></td><td>
