	...
	<div class="content">
		<table class="list_table">
			...
			<tbody>
				...
				<?php $query = new IQuery("refundment_doc");$query->where = "if_del = 0 and pay_status = 0";$query->order = "id desc";$query->page = "$page";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>
