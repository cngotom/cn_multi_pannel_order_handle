					...
					<td>
						...
						<span class="<?php echo strpos($item['if_print'],'express') === false ? 'prt':'prted';?>" title="快递单打印" onclick="window.open('<?php echo IUrl::creatUrl("/order/expresswaybill_template/id/$item[oid]");?>');">递</span>
                                                                        ...
                                                                        <?php }else{?>
                                                                            <?php  
                                                                                $id = $item['oid'];
                                                                                $volumes_title = Giftcard::get_card_title_by_order($id);
                                                                            ?>
                                                                             <td title="<?php echo isset($volumes_title)?$volumes_title:"";?>"><?php echo isset($volumes_title)?$volumes_title:"";?></td>
                                                                        <?php }?>
