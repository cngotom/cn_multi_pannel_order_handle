...
<head>
	...
	seo::set($seo_data);
?>
<link rel="stylesheet" href="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/css/media.css";?>" />

<div class="position"> <span>您当前的位置：</span> <a href="<?php echo IUrl::creatUrl("");?>"> 首页</a> » 商城资讯 </div>
        ...
        <div class="gift_theme">
            ...
            <div class="gL_up">
                    <img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/index/news_L_top.jpg";?>"></div>
                <div class="gL_middle">
            ...
            <div class="giftbooks_right">
                ...
                <div class="gb_Rcontent_middle">
                           <h3 class="news_tit">
                        <span id="lblTitle"><?php echo isset($this->articleRow['title'])?$this->articleRow['title']:"";?></span></h3>
                    <p class="date">
                        发布日期：<span><span id="lblEditTime"><?php echo isset($this->articleRow['create_time'])?$this->articleRow['create_time']:"";?></span></span></p>
                  <?php echo isset($this->articleRow['content'])?$this->articleRow['content']:"";?>
