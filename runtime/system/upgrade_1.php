...
<div class="content">
	<div class="upgrade_box">
		<div class="gray_title"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/error.gif";?>" />无法进行在线升级</div>
		<div class="cont">
			<h3><?php echo isset($this->msg)?$this->msg:"";?></h3>
		</div>
	</div>
</div>
<?php }?>
