...
class Ucenter extends IController
{
    ...
    public function order_detail()
    {
		...
		$this->express_open = isset($config_info['express_open']) ? $config_info['express_open']  : '';
    ...
    function password_edit()
    {
    	...
    	else
    	{
	    	...
	    	if($result)
	    	{
	    		$this->user['user_pwd'] = $password;
	    		ISafe::set('user_pwd',$password);
	    		$message = '密码修改成功';
	    	}
	    	else
	    	{
