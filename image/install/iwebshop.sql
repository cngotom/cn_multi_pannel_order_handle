...
CREATE TABLE `iweb_order` (
  ...
  `pay_status` tinyint(1) default '0' COMMENT '支付状态 0：未支付，1：已支付，2：退款，3：申请退款',
  `distribution_status` tinyint(1) default '0' COMMENT '配送状态0：未发送，1：已发送，2：换货，3：申请换货',
  `accept_name` varchar(20) NOT NULL COMMENT '收货人姓名',
  `postcode` varchar(6) default NULL COMMENT '邮编',
  `telphone` varchar(20) default NULL COMMENT '联系电话',
  `country` int(11) default NULL COMMENT '国ID',
...
CREATE TABLE `iweb_order_goods` (
  ...
  `shipments` smallint(5) NOT NULL default '0' COMMENT '发货数量',
...
CREATE TABLE `iweb_returns_doc` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `delivery_type` int(11) unsigned NOT NULL COMMENT '物流ID',
  `order_id` int(11) unsigned NOT NULL COMMENT '订单ID',
  `user_id` int(11) unsigned default NULL COMMENT '退货用户ID',
  `admin_id` int(11) unsigned default NULL COMMENT '管理员ID',
  ...
  `if_del` tinyint(1) default NULL COMMENT '1为删除',
  `state` tinyint(1) default NULL COMMENT '0申请退货1退货成功2退货失败',
  PRIMARY KEY  (`id`)
...
CREATE TABLE `iweb_user_group` (
  ...
  `discount` decimal(15,2) NOT NULL default '0' COMMENT '折扣率',
...
INSERT INTO `iwebshop_right` VALUES (71, '[订单]订单状态修改', 'order@order_return_doc,order@order_delivery_doc,order@order_collection_doc,order@order_complete,order@order_refundment,order@order_collection,order@order_deliver,order@order_return', 0);
...
INSERT INTO `iwebshop_right` VALUES (118, '[系统]配送管理', 'system@express_update,system@freight_recycle_del,system@freight_recycle_restore,system@freight_recycle,system@freight_del,system@freight_update,system@area_del,system@area_save,system@area_edit,system@area_sort,system@area_sub_child,system@delivery_update,system@delivery_operate,system@delivery_edit,system@express,system@freight_edit,system@freight_list,system@area,system@delivery,system@delivery_recycle', 0);
...
INSERT INTO `iweb_payment` VALUES (5, '支付宝', 1, 'alipay', '支付宝（中国）网络技术有限公司是国内领先的独立第三方支付平台，是阿里巴巴集团的关联公司。', '/payments/logos/pay_alipay.gif', 1, 99, NULL, 0.00, 1, NULL, NULL);
INSERT INTO `iweb_payment` VALUES (6, 'PayPal', 1, 'paypal', '是全球最大的在线支付平台，同时也是目前全球贸易网上支付标准。', '/payments/logos/pay_paypal.gif', 1, 99, NULL, 0.00, 1, NULL, NULL);